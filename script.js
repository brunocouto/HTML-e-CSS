function codificar() {
    let novoTexto = input.value.replace(/a|e|i|o|u/g, function (ocorrencia) {
        return codifica[ocorrencia.toLowerCase()] || ocorrencia;
    });
    output.value = novoTexto;
}

function decodificar() {
    let novoTexto = input.value.replace(/ai|enter|imes|ober|ufat/gi, function (ocorrencia) {
        return decodifica[ocorrencia.toLowerCase()] || ocorrencia;
    });
    output.value = novoTexto;
}
